...
public class loggedinPage extends browserDriver {
    ...
    public static void visibilityProductCategory_formalShoes() throws InterruptedException {
    ...
    public static void visibilityProductCategory_sportsShoes() throws InterruptedException {
    ...
    public static void visibilityProductCategory_sneakersShoes() throws InterruptedException {
